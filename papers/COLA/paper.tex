...
\>[25]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\;\V{x}\mskip1.5mu\}\;\rightarrow\;(\V{idx}\;\mathbin{:}\;(\V{x}\;\red{,}\,\;\V{\tau})\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[25]{}\hsindent{10}{}\<[35]%
\>[35]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;(\V{x}\;\red{,}\,\;\Con{nil})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}getlabel}\;{}\<[25]%
\>[25]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{l}\;\V{\tau}\;\V{\Gamma_1}\;\V{x}\mskip1.5mu\}\;\rightarrow\;(\V{idx}\;\mathbin{:}\;(\V{x}\;\red{,}\,\;\V{\tau})\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[25]{}\hsindent{15}{}\<[40]%
\>[40]{}\rightarrow\;\V{\Pi}\;\D{[}\;\V{l}\;\D{]=}\;\V{\Gamma_1}\;{}\<[E]%
\\
\>[25]{}\hsindent{15}{}\<[40]%
\>[40]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;(\V{x}\;\red{,}\,\;\Con{cont}\;\V{\Gamma_1})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Next, constructor \ensuremath{\Con{instr\textrm{-}getlabel}} show that any other label $l$ should be typed with a continuation
...
\>[25]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{l}\;\V{x}\;\V{\Gamma_1}\mskip1.5mu\}\;\rightarrow\;(\V{x}\;\red{,}\,\;\Con{cont}\;\V{\Gamma_1})\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
...
add its corresponding equation on function \ensuremath{\F{forge\textrm{-}types\textrm{-}instr}}, which erases type information
...
\>[17]{}\mathbin{:}\;(\V{v}\;\mathbin{:}\;\V{ℕ})\;\rightarrow\;\D{Label}\;\rightarrow\;\D{UInstr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Pi}\;\V{\Gamma}\;\V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;\V{\Gamma'}\;\rightarrow\;\D{UInstr}{}\<[E]%
\\
\>[B]{}\orange{\texttt{-- same code as before...}}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}getlabel\textrm{-}0}\;\{\mskip1.5mu \V{x}\;\mathrel{=}\;\V{x}\mskip1.5mu\}\;\V{v})\;\mathrel{=}\;\Con{get\textrm{-}label}\;\V{x}\;\Con{L_{0}}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}getlabel}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\{\mskip1.5mu \V{x}\;\mathrel{=}\;\V{x}\mskip1.5mu\}\;\V{v}\;\V{p})\;\mathrel{=}\;\Con{get\textrm{-}label}\;\V{x}\;\V{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\Con{get\textrm{-}label}} is typed using rule \ensuremath{\Con{instr\textrm{-}getlabel\textrm{-}0}} we consider the initial label \ensuremath{\Con{L_{0}}}. Next, we implement
the type checker logic for \ensuremath{\Con{get\textrm{-}label}}. Function \ensuremath{\F{check\textrm{-}get\textrm{-}label}} verifies if the label is present at
...
\\
\>[B]{}\F{check\textrm{-}get\textrm{-}label}\;\V{\Pi}\;\V{\Gamma}\;\V{v}\;\V{l}\;\mid \;\V{\Gamma_1}\;\F{with\equiv}\;\V{p}\;\mathkw{with}\;\F{lookup\textrm{-}var}\;\V{\Gamma}\;\V{v}{}\<[E]%
\\
\>[B]{}\V{...}\;\mid \;\Con{nothing}\;\mathrel{=}\;\F{type\textrm{-}error}\;\text{\ttfamily \char34 check-get-label:~variable~out~of~scope\char34}{}\<[E]%
\\
\>[B]{}\V{...}\;\mid \;\Con{just}\;(\V{\tau}\;\red{,}\,\;\V{idx})\;\mathrel{=}\;\Con{right}\;(\Con{ok}\;(\Con{instr\textrm{-}getlabel}\;\V{idx}\;(\F{lookup⇒[]=}\;\V{l}\;\V{\Pi}\;\V{p}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Con{cont}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{l}\;\V{\Gamma_1}\mskip1.5mu\}\;\rightarrow\;\V{\Pi}\;\D{[}\;\V{l}\;\D{]=}\;\V{\Gamma_1}\;\rightarrow\;\D{Val}\;(\Con{cont}\;\V{\Gamma_1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\Con{get\textrm{-}label}} instruction and fixing the \ensuremath{\Con{jump}} implementation.
...
correctness of the type checker~\cite{AppelMRV07}, which rely on a Coq library inspired by modal logics. We stick to our initial
proposal based on dependently typed syntax and definitional interpreters.
