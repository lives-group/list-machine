...
\\
\>[26]{}\rightarrow\;\V{\tau_1}\;\D{\in}\;\V{\Gamma}\;\rightarrow\;\Con{list}\;\V{\tau_0}\;\D{\sqcup}\;\V{\tau_1}\;\D{=}\;\Con{list}\;\V{\tau}\;{}\<[E]%
\\
...
\\
\>[26]{}\rightarrow\;\Con{list}\;\V{\tau_0}\;\D{\sqcup}\;\V{\tau_1}\;\D{=}\;\Con{list}\;\V{\tau}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;\Con{listcons}\;\V{\tau}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
type \ensuremath{\V{\tau_1}\;\D{\sqcup}\;\V{\tau_2}\;\D{=}\;\V{\tau}}, which encodes that the least common supertype of \ensuremath{\V{\tau_1}} and \ensuremath{\V{\tau_2}} is \ensuremath{\V{\tau}}.
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{data}\;\D{\_\sqcup\_=\_}\;\mathkw{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub0}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;\V{t}\;\D{\sqcup}\;\V{t}\;\D{=}\;\V{t}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub1}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;(\Con{list}\;\V{t})\;\D{\sqcup}\;\Con{nil}\;\D{=}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub4}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;\Con{nil}\;\D{\sqcup}\;(\Con{list}\;\V{t})\;\D{=}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub2}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{=}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{listcons}\;\V{t1})\;\D{=}\;\V{t'}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub2b}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{=}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{9}{}\<[12]%
\>[12]{}(\Con{listcons}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{=}\;\V{t'}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub3}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;\V{t}\;\D{\sqcup}\;\V{t1}\;\D{=}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{=}\;(\Con{list}\;\V{t'}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub5}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;(\Con{listcons}\;\V{t})\;\D{\sqcup}\;\Con{nil}\;\D{=}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub6}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;\Con{nil}\;\D{\sqcup}\;(\Con{listcons}\;\V{t})\;\D{=}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub7}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;\V{t}\;\D{\sqcup}\;\V{t1}\;\D{=}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}(\Con{listcons}\;\V{t})\;\D{\sqcup}\;(\Con{listcons}\;\V{t1})\;\D{=}\;(\Con{listcons}\;\V{t'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{\sqcup\textrm{-}comm}\;\mathbin{:}\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{=}\;\V{t3}\;\rightarrow\;\V{t2}\;\D{\sqcup}\;\V{t1}\;\D{=}\;\V{t3}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{\sqcup\textrm{-}subtype}\;\mathbin{:}\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{=}\;\V{t3}\;\rightarrow\;(\V{t1}\;\D{<:}\;\V{t3})\;\D{\land}\;(\V{t2}\;\D{<:}\;\V{t3}){}\<[E]%
\\
\>[B]{}\F{\sqcup\textrm{-}least}\;\mathbin{:}\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{=}\;\V{t3}\;\rightarrow\;\V{t1}\;\D{<:}\;\V{t3}\;\rightarrow\;\V{t2}\;\D{<:}\;\V{t3}\;\rightarrow\;\V{t3}\;\D{<:}\;\V{t4}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{lub}\;\mathbin{:}\;(\V{t1}\;\V{t2}\;\mathbin{:}\;\D{Ty})\;\rightarrow\;\V{∃}\;(\lambda\;\V{t}\;\rightarrow\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{=}\;\V{t}){}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;\{\mskip1.5mu \V{\Pi}\;\mathbin{:}\;\D{PCtx}\;\V{n}\mskip1.5mu\}\;\{\mskip1.5mu \V{\Gamma}\;\V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;\V{\Gamma'}\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}seq}\;\V{p}\;\V{p₁})\;\mathrel{=}\;\Con{seq}\;(\F{forget\textrm{-}types\textrm{-}instr}\;\V{p})\;(\F{forget\textrm{-}types\textrm{-}instr}\;\V{p₁}){}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}branch\textrm{-}list}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{idx}\;\V{x}\;\V{x₁})\;\mathrel{=}\;\Con{branch\textrm{-}if\textrm{-}nil}\;(\F{index}\;\V{idx})\;\V{l}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}branch\textrm{-}listcons}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{idx}\;\V{x}\;\V{x₁})\;\mathrel{=}\;\Con{branch\textrm{-}if\textrm{-}nil}\;(\F{index}\;\V{idx})\;\V{l}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}branch\textrm{-}nil}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{x}\;\V{x₁}\;\V{x₂})\;\mathrel{=}\;\Con{branch\textrm{-}if\textrm{-}nil}\;(\F{index}\;\V{x})\;\V{l}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}0\textrm{-}new}\;\{\mskip1.5mu \V{v'}\;\mathrel{=}\;\V{v'}\mskip1.5mu\}\;\V{x})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}0}\;(\F{index}\;\V{x})\;\V{v'}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}0\textrm{-}upd}\;\V{x}\;\V{idx})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}0}\;(\F{index}\;\V{x})\;(\F{index}\;\V{idx}){}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}1\textrm{-}new}\;\{\mskip1.5mu \V{v'}\;\mathrel{=}\;\V{v'}\mskip1.5mu\}\;\V{x})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}1}\;(\F{index}\;\V{x})\;\V{v'}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}1\textrm{-}upd}\;\V{x}\;\V{idx})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}1}\;(\F{index}\;\V{x})\;(\F{index}\;\V{idx}){}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}cons\textrm{-}new}\;\{\mskip1.5mu \V{v'}\;\mathrel{=}\;\V{v'}\mskip1.5mu\}\;\V{x}\;\V{x₁}\;\V{x₂})\;\mathrel{=}\;\Con{cons}\;(\F{index}\;\V{x})\;(\F{index}\;\V{x₁})\;\V{v'}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}cons\textrm{-}upd}\;\V{x}\;\V{x₁}\;\V{idx}\;\V{x₂})\;\mathrel{=}\;\Con{cons}\;(\F{index}\;\V{x})\;(\F{index}\;\V{x₁})\;(\F{index}\;\V{idx}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{ok}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;(\V{i}\;\mathbin{:}\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;\V{\Gamma'})\;\rightarrow\;\D{CheckedInstr}\;\V{\Pi}\;\V{\Gamma}\;(\F{forget\textrm{-}types\textrm{-}instr}\;\V{i}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{21}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{check\textrm{-}fetch\textrm{-}field\textrm{-}0}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;(\V{\Pi}\;\mathbin{:}\;\D{PCtx}\;\V{n})\;\V{\Gamma}\;\V{v}\;\V{v'}\;{}\<[E]%
\\
\>[B]{}\hsindent{21}{}\<[21]%
\>[21]{}\rightarrow\;\D{TC}\;(\D{CheckedInstr}\;\V{\Pi}\;\V{\Gamma}\;(\Con{fetch\textrm{-}field\textrm{-}0}\;\V{v}\;\V{v'})){}\<[E]%
\\
...
the label involved is the special label $L_0$. Intuitively, the constructor \ensuremath{\Con{instr\textrm{-}getlabel\textrm{-}0}} type
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{postulate}\;\F{sub\textrm{-}env}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Gamma}\;\V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;\V{\Gamma'}\;\D{\subset}\;\V{\Gamma}\;\rightarrow\;\D{Env}\;\V{\Gamma}\;\rightarrow\;\D{Env}\;\V{\Gamma'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
