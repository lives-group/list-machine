...
add its corresponding equation on function \ensuremath{\F{forget\textrm{-}types\textrm{-}instr}}, which erases type information
...
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}getlabel\textrm{-}0}\;\{\mskip1.5mu \V{x}\;\mathrel{=}\;\V{x}\mskip1.5mu\}\;\V{v})\;\mathrel{=}\;\Con{get\textrm{-}label}\;\V{x}\;\Con{L_{0}}{}\<[E]%
\\
