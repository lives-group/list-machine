...
Constructor \ensuremath{\Con{\lbrack\:\rbrack}} builds empty vectors. The cons-operator (\ensuremath{\Con{\_::\_}})\footnote{Agda supports the definition of mixfix operators.
...
which asserts that the only value equal to \ensuremath{\V{x}} is itself.
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Con{Even}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\;\mathbin{:}\;\D{\mathbb{N}}\mskip1.5mu\}\;\to \;\D{Parity}\;(\V{n}\;\F{+}\;\V{n}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Con{Odd}\;{}\<[9]%
...
\\
\>[B]{}\F{natToBin}\;\Con{zero}\;\mathrel{=}\;\Con{\lbrack\:\rbrack}{}\<[E]%
\\
\>[B]{}\F{natToBin}\;\V{k}\;\mathkw{with}\;(\F{parity}\;\V{k}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\F{natToBin}\;(\V{j}\;\F{+}\;\V{j})\;{}\<[25]%
\>[25]{}\mid \;\Con{Even}\;\mathrel{=}\;\Con{false}\;\Con{::}\;\F{natToBin}\;\V{j}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\F{natToBin}\;(\Con{suc}\;(\V{j}\;\F{+}\;\V{j}))\;\mid \;\Con{Odd}\;{}\<[35]%
\>[35]{}\mathrel{=}\;\Con{true}\;{}\<[43]%
\>[43]{}\Con{::}\;\F{natToBin}\;\V{j}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
over natural numbers, \ensuremath{\D{P}}.
...
\column{25}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{postulate}\;\F{plus\textrm{-}comm}\;\mathbin{:}\;(\V{a}\;\V{b}\;\mathbin{:}\;\D{\mathbb{N}})\;\V{→}\;\V{a}\;\F{+}\;\V{b}\;\D{\equiv}\;\V{b}\;\F{+}\;\V{a}{}\<[E]%
\\
\>[B]{}\mathkw{postulate}\;\D{P}\;\mathbin{:}\;\D{\mathbb{N}}\;\V{→}\;\D{Set}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\F{foo}\;\mathbin{:}\;(\V{a}\;\V{b}\;\mathbin{:}\;\D{\mathbb{N}})\;\V{→}\;\D{P}\;(\V{a}\;\F{+}\;\V{b})\;\V{→}\;\D{P}\;(\V{b}\;\F{+}\;\V{a}){}\<[E]%
\\
\>[B]{}\F{foo}\;\V{a}\;\V{b}\;\V{t}\;\mathkw{with}\;{}\<[18]%
\>[18]{}\V{a}\;\F{+}\;\V{b}\;{}\<[25]%
\>[25]{}\mid \;\F{plus\textrm{-}comm}\;\V{a}\;\V{b}{}\<[E]%
\\
\>[B]{}\F{foo}\;\V{a}\;\V{b}\;\V{t}\;{}\<[14]%
\>[14]{}\mid \;.\;(\V{b}\;\F{+}\;\V{a})\;\mid \;\Con{refl}\;\mathrel{=}\;\V{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Function \ensuremath{\F{foo}} uses the \ensuremath{\mathkw{with}} construct to pattern-match on the equality produced
by \ensuremath{\F{plus\textrm{-}comm}},  \ensuremath{\V{a}\;\F{+}\;\V{b}\;\D{\equiv}\;\V{b}\;\F{+}\;\V{a}}. Since the propositional equality type has only one
constructor, \ensuremath{\Con{refl}}, matching over it makes Agda type checker to replace
all occurrences of \ensuremath{\V{a}\;\F{+}\;\V{b}} to \ensuremath{\V{b}\;\F{+}\;\V{a}} in the current equation context. We can notice
this by the use of the \empth{dotted-pattern} \ensuremath{.\;(\V{b}\;\F{+}\;\V{a})} which indicates that the
only way that this equation is correct is when the first result of the \ensuremath{\mathkw{with}} construct
is \ensuremath{\V{b}\;\F{+}\;\V{a}}. The use of dependent pattern matching to rewrite equalities in functions is
so common in Agda that the language provides a syntax sugar that simplifies such structure.
The \ensuremath{\mathkw{rewrite}} construct allows the substitution of an equality in all values in a certain
equation. The \ensuremath{\F{foo}} function could be represented more concisely, using \ensuremath{\mathkw{rewrite}}, as:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{foo}\;\mathbin{:}\;(\V{a}\;\V{b}\;\mathbin{:}\;\D{\mathbb{N}})\;\V{→}\;\D{P}\;(\V{a}\;\F{+}\;\V{b})\;\V{→}\;\D{P}\;(\V{b}\;\F{+}\;\V{a}){}\<[E]%
\\
\>[B]{}\F{foo}\;\V{a}\;\V{b}\;\V{t}\;\mathkw{rewrite}\;\F{plus\textrm{-}comm}\;\V{a}\;\V{b}\;\mathrel{=}\;\V{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Another inductive predicate used in our formalization is the type \ensuremath{\D{All}\;\D{P}\;\V{xs}} which
ensures that all elements of a vector \ensuremath{\V{xs}} satisfy a predicate \ensuremath{\D{P}\;\mathbin{:}\;\V{A}\;\to \;\D{Set}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathkw{data}\;\D{All}\;(\D{P}\;\mathbin{:}\;\V{A}\;\to \;\D{Set})\;\mathbin{:}\;\D{Vec}\;\V{A}\;\V{n}\;\to \;{}\<[41]%
\>[41]{}\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Con{\lbrack\:\rbrack}\;\mathbin{:}\;\D{All}\;\D{P}\;\Con{\lbrack\:\rbrack}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Con{\_::\_}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{x}\;\V{xs}\mskip1.5mu\}\;\to \;\D{P}\;\V{x}\;\to \;\D{All}\;\D{P}\;\V{xs}\;\to \;\D{All}\;\D{P}\;(\V{x}\;\Con{::}\;\V{xs}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
The first constructor specifies that \ensuremath{\D{All}\;\D{P}} holds for the empty vector and
constructor \ensuremath{\Con{\_::\_}} builds a proof of \ensuremath{\D{All}\;\D{P}\;(\V{x}\;\Con{::}\;\V{xs})} from proofs of
\ensuremath{\D{P}\;\V{x}} and \ensuremath{\D{All}\;\D{P}\;\V{xs}}. Since this type has the same structure of vectors,
...
proof of \ensuremath{\D{P}} for the element at position \ensuremath{\V{v}\;\mathbin{:}\;\D{Fin}\;\V{n}} in a \ensuremath{\D{Vec}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[4]{}\F{lookup}\;\mathbin{:}\;\{\mskip1.5mu \V{xs}\;\mathbin{:}\;\D{Vec}\;\V{A}\;\V{n}\mskip1.5mu\}\;\to \;\D{Fin}\;\V{n}\;\to \;\D{All}\;\D{P}\;\V{xs}\;\to \;\D{P}\;\V{x}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\D{PCtx}\;\mathbin{:}\;\D{\mathbb{N}}\;\rightarrow\;\D{Set}{}\<[E]%
\\
\>[B]{}\D{PCtx}\;\V{n}\;\mathrel{=}\;\D{Vec}\;\D{Ctx}\;\V{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\;\V{l}\;\V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;(\V{idx}\;\mathbin{:}\;\Con{list}\;\V{\tau}\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{[}\;\V{l}\;\D{]=}\;\V{\Gamma'}\;\rightarrow\;(\V{idx}\;\F{::=}\;\Con{nil})\;\D{\subset}\;\V{\Gamma'}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;\Con{listcons}\;\V{\tau}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}branch\textrm{-}listcons}\;{}\<[26]%
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\;\V{l}\;\V{\Gamma_1}\mskip1.5mu\}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;(\V{idx}\;\mathbin{:}\;(\Con{listcons}\;\V{\tau})\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{[}\;\V{l}\;\D{]=}\;\V{\Gamma_1}\;\rightarrow\;(\V{idx}\;\F{::=}\;\Con{nil})\;\D{\subset}\;\V{\Gamma_1}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;\V{\Gamma}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}branch\textrm{-}nil}\;{}\<[26]%
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Gamma_1}\;\V{l}\mskip1.5mu\}\;\rightarrow\;\V{x}\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
...
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\mskip1.5mu\}\;\rightarrow\;\Con{listcons}\;\V{\tau}\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{\tau}\;\Con{::}\;\V{\Gamma}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}fetch\textrm{-}0\textrm{-}upd}\;{}\<[26]%
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\;\V{\tau'}\mskip1.5mu\}\;\rightarrow\;\Con{listcons}\;\V{\tau}\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;(\V{idx}\;\mathbin{:}\;\V{\tau'}\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;\V{\tau}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}fetch\textrm{-}1\textrm{-}new}\;{}\<[26]%
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\mskip1.5mu\}\;\rightarrow\;(\Con{listcons}\;\V{\tau})\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\Con{list}\;\V{\tau}\;\Con{::}\;\V{\Gamma}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\>[26]{}\rightarrow\;(\V{idx}\;\mathbin{:}\;\V{\tau'}\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;\Con{list}\;\V{\tau}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}cons\textrm{-}new}\;{}\<[26]%
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\;\V{\tau_0}\;\V{\tau_1}\mskip1.5mu\}\;\rightarrow\;\V{\tau_0}\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\tau_1}\;\D{\in}\;\V{\Gamma}\;\rightarrow\;\Con{list}\;\V{\tau_0}\;\D{\sqcup}\;\V{\tau_1}\;\D{\sim}\;\Con{list}\;\V{\tau}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\Con{listcons}\;\V{\tau})\;\Con{::}\;\V{\Gamma}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}cons\textrm{-}upd}\;{}\<[26]%
\>[26]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\;\V{\tau_0}\;\V{\tau_1}\;\V{\tau_2}\mskip1.5mu\}\;\rightarrow\;\V{\tau_0}\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\tau_1}\;\D{\in}\;\V{\Gamma}\;\rightarrow\;(\V{idx}\;\mathbin{:}\;\V{\tau_2}\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\Con{list}\;\V{\tau_0}\;\D{\sqcup}\;\V{\tau_1}\;\D{\sim}\;\Con{list}\;\V{\tau}\;{}\<[E]%
\\
\>[26]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;\Con{listcons}\;\V{\tau}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
index \ensuremath{\V{\tau}\;\D{\in}\;\V{\Gamma}}, which witnesses the existence of an element \ensuremath{\V{\tau}} in \ensuremath{\V{\Gamma}},
...
existing variable. The list is created from two variables, \ensuremath{\V{\tau_0}\;\D{\in}\;\V{\Gamma}} and \ensuremath{\V{\tau_1}\;\D{\in}\;\V{\Gamma}},
...
type \ensuremath{\V{\tau_1}\;\D{\sqcup}\;\V{\tau_2}\;\D{\sim}\;\V{\tau}}, which encodes that the least common supertype of \ensuremath{\V{\tau_1}} and \ensuremath{\V{\tau_2}} is \ensuremath{\V{\tau}}.
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{data}\;\D{\_\sqcup\_\sim\_}\;\mathkw{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub0}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;\V{t}\;\D{\sqcup}\;\V{t}\;\D{\sim}\;\V{t}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub1}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;(\Con{list}\;\V{t})\;\D{\sqcup}\;\Con{nil}\;\D{\sim}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub4}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;\Con{nil}\;\D{\sqcup}\;(\Con{list}\;\V{t})\;\D{\sim}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub2}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{\sim}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{8}{}\<[11]%
\>[11]{}(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{listcons}\;\V{t1})\;\D{\sim}\;\V{t'}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub2b}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{\sim}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{9}{}\<[12]%
\>[12]{}(\Con{listcons}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{\sim}\;\V{t'}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub3}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;\V{t}\;\D{\sqcup}\;\V{t1}\;\D{\sim}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}(\Con{list}\;\V{t})\;\D{\sqcup}\;(\Con{list}\;\V{t1})\;\D{\sim}\;(\Con{list}\;\V{t'}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub5}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;(\Con{listcons}\;\V{t})\;\D{\sqcup}\;\Con{nil}\;\D{\sim}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub6}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\mskip1.5mu\}\;\rightarrow\;\Con{nil}\;\D{\sqcup}\;(\Con{listcons}\;\V{t})\;\D{\sim}\;(\Con{list}\;\V{t}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{lub7}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{t}\;\V{t1}\;\V{t'}\mskip1.5mu\}\;\rightarrow\;\V{t}\;\D{\sqcup}\;\V{t1}\;\D{\sim}\;\V{t'}\;\rightarrow\;{}\<[E]%
\\
\>[3]{}\hsindent{10}{}\<[13]%
\>[13]{}(\Con{listcons}\;\V{t})\;\D{\sqcup}\;(\Con{listcons}\;\V{t1})\;\D{\sim}\;(\Con{listcons}\;\V{t'}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{\sqcup\textrm{-}comm}\;\mathbin{:}\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{\sim}\;\V{t3}\;\rightarrow\;\V{t2}\;\D{\sqcup}\;\V{t1}\;\D{\sim}\;\V{t3}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
We omit the complete definition of \ensuremath{\F{\sqcup\textrm{-}comm}} for brevity. In the list-machine benchmark definition,
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{\sqcup\textrm{-}subtype}\;\mathbin{:}\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{\sim}\;\V{t3}\;\rightarrow\;(\V{t1}\;\D{<:}\;\V{t3})\;\D{\land}\;(\V{t2}\;\D{<:}\;\V{t3}){}\<[E]%
\\
\>[B]{}\F{\sqcup\textrm{-}least}\;\mathbin{:}\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{\sim}\;\V{t3}\;\rightarrow\;\V{t1}\;\D{<:}\;\V{t3}\;\rightarrow\;\V{t2}\;\D{<:}\;\V{t3}\;\rightarrow\;\V{t3}\;\D{<:}\;\V{t4}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{lub}\;\mathbin{:}\;(\V{t1}\;\V{t2}\;\mathbin{:}\;\D{Ty})\;\rightarrow\;\V{∃}\;(\lambda\;\V{t}\;\rightarrow\;\V{t1}\;\D{\sqcup}\;\V{t2}\;\D{\sim}\;\V{t}){}\<[E]%
\\
...
following the rule \emph{step-branch-taken} of \cite{Appel07}. In this case, variable \ensuremath{\V{v}}
has value \ensuremath{\Con{nil}}, and
...
Agda's standard library function \ensuremath{\F{[]\textrm{=}{\Rightarrow}lookup}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{14}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{[]\textrm{=}{\Rightarrow}lookup}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{px}\;\mathbin{:}\;\D{P}\;\V{x}\mskip1.5mu\}\;\{\mskip1.5mu \V{pxs}\;\mathbin{:}\;\D{All}\;\D{P}\;\V{xs}\mskip1.5mu\}\;\{\mskip1.5mu \V{i}\;\mathbin{:}\;\V{x}\;\D{\in}\;\V{xs}\mskip1.5mu\}\;\rightarrow\;{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}\V{pxs}\;\D{[}\;\V{i}\;\D{]=}\;\V{px}\;\rightarrow\;{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}\F{lookupA}\;\V{pxs}\;\V{i}\;\D{\equiv}\;\V{px}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
which rewrites a lookup predicate (\ensuremath{\V{pxs}\;\D{[}\;\V{i}\;\D{]=}\;\V{px}}) into an equality using the \ensuremath{\F{lookupA}}
function, \ensuremath{\F{lookupA}\;\V{pxs}\;\V{i}\;\D{\equiv}\;\V{px}}.}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
...
function \ensuremath{\F{update\textrm{-}env}}\footnote{The source-code of this function can be found in our online
...
and \ensuremath{\F{lub\textrm{-}of\textrm{-}subtype}}. These lemmas and their proofs can be found in our repository online~\cite{list-rep}. }
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{index}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{A}\;\mathbin{:}\;\D{Set}\mskip1.5mu\}\;\{\mskip1.5mu \V{t}\;\mathbin{:}\;\V{A}\mskip1.5mu\}\;\{\mskip1.5mu \V{\Gamma}\;\mathbin{:}\;\D{List}\;\V{A}\mskip1.5mu\}\;\rightarrow\;\V{t}\;\D{\in}\;\V{\Gamma}\;\rightarrow\;\D{\mathbb{N}}{}\<[E]%
\\
\>[B]{}\F{index}\;(\Con{here}\;\V{px})\;\mathrel{=}\;\Con{zero}{}\<[E]%
\\
\>[B]{}\F{index}\;(\Con{there}\;\V{p})\;\mathrel{=}\;\Con{suc}\;(\F{index}\;\V{p}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{data}\;\D{Lookup}\;\{\mskip1.5mu \V{A}\;\mathbin{:}\;\D{Set}\mskip1.5mu\}\;(\V{xs}\;\mathbin{:}\;\D{List}\;\V{A})\;\mathbin{:}\;\D{\mathbb{N}}\;\rightarrow\;\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{inside}\;\mathbin{:}\;(\V{x}\;\mathbin{:}\;\V{A})\;(\V{p}\;\mathbin{:}\;\V{x}\;\D{\in}\;\V{xs})\;\rightarrow\;\D{Lookup}\;\V{xs}\;(\F{index}\;\V{p}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{outside}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;\rightarrow\;\D{Lookup}\;\V{xs}\;\V{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Using this infrastructure we can build the function \ensuremath{\F{lookup\textrm{-}var}} which
returns a value of type \ensuremath{\D{Lookup}\;\V{xs}\;\V{n}} that specifies whether \ensuremath{\V{n}} is
a valid list position or not.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{lookup\textrm{-}var}\;\mathbin{:}\;\{\mskip1.5mu \V{A}\;\mathbin{:}\;\D{Set}\mskip1.5mu\}\;(\V{xs}\;\mathbin{:}\;\D{List}\;\V{A})\;(\V{n}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{Lookup}\;\V{xs}\;\V{n}{}\<[E]%
\\
\>[B]{}\F{lookup\textrm{-}var}\;\Con{\lbrack\:\rbrack}\;\V{n}\;\mathrel{=}\;\Con{outside}{}\<[E]%
\\
\>[B]{}\F{lookup\textrm{-}var}\;(\V{x}\;\Con{::}\;\V{xs})\;\Con{zero}\;\mathrel{=}\;\Con{inside}\;\V{x}\;(\Con{here}\;\Con{refl}){}\<[E]%
\\
\>[B]{}\F{lookup\textrm{-}var}\;(\V{x}\;\Con{::}\;\V{xs})\;(\Con{suc}\;\V{n})\;\mathkw{with}\;\F{lookup\textrm{-}var}\;\V{xs}\;\V{n}{}\<[E]%
\\
\>[B]{}\F{lookup\textrm{-}var}\;(\V{x}\;\Con{::}\;\V{xs})\;(\Con{suc}\;.\;(\F{index}\;\V{p}))\;\mid \;\Con{inside}\;\V{y}\;\V{p}\;\mathrel{=}\;\Con{inside}\;\V{y}\;(\Con{there}\;\V{p}){}\<[E]%
\\
\>[B]{}\F{lookup\textrm{-}var}\;(\V{x}\;\Con{::}\;\V{xs})\;(\Con{suc}\;\anonymous )\;\mid \;\Con{outside}\;\mathrel{=}\;\Con{outside}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{data}\;\D{UInstr}\;(\V{n}\;\mathbin{:}\;\D{\mathbb{N}})\;\mathbin{:}\;\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{jump}\;{}\<[17]%
\>[17]{}\mathbin{:}\;(\V{x}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{Label}\;\V{n}\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{branch\textrm{-}if\textrm{-}nil}\;\mathbin{:}\;(\V{v}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{Label}\;\V{n}\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{fetch\textrm{-}field\textrm{-}0}\;\mathbin{:}\;(\V{v}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;(\V{v′}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{fetch\textrm{-}field\textrm{-}1}\;\mathbin{:}\;(\V{v}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;(\V{v′}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{get\textrm{-}label}\;{}\<[17]%
\>[17]{}\mathbin{:}\;(\V{v}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{Label}\;\V{n}\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{cons}\;{}\<[17]%
\>[17]{}\mathbin{:}\;(\V{v₀}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;(\V{v₁}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;(\V{v′}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{halt}\;{}\<[17]%
\>[17]{}\mathbin{:}\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{seq}\;{}\<[17]%
\>[17]{}\mathbin{:}\;\D{UInstr}\;\V{n}\;\rightarrow\;\D{UInstr}\;\V{n}\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Type \ensuremath{\D{UInstr}} has a constructor for each of the list machine instructions,
type \ensuremath{\D{Label}\;\V{n}} denote a program label and it is represented by
a value of type \ensuremath{\D{Fin}\;\V{n}}. Next, we define an erasure function for
our intrinsically typed syntax:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;\{\mskip1.5mu \V{\Pi}\;\mathbin{:}\;\D{PCtx}\;\V{n}\mskip1.5mu\}\;\{\mskip1.5mu \V{\Gamma}\;\V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;\V{\Gamma'}\;\rightarrow\;\D{UInstr}\;\V{n}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}seq}\;\V{p}\;\V{p₁})\;\mathrel{=}\;\Con{seq}\;(\F{forge\textrm{-}types\textrm{-}instr}\;\V{p})\;(\F{forge\textrm{-}types\textrm{-}instr}\;\V{p₁}){}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}branch\textrm{-}list}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{idx}\;\V{x}\;\V{x₁})\;\mathrel{=}\;\Con{branch\textrm{-}if\textrm{-}nil}\;(\F{index}\;\V{idx})\;\V{l}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}branch\textrm{-}listcons}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{idx}\;\V{x}\;\V{x₁})\;\mathrel{=}\;\Con{branch\textrm{-}if\textrm{-}nil}\;(\F{index}\;\V{idx})\;\V{l}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}branch\textrm{-}nil}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{x}\;\V{x₁}\;\V{x₂})\;\mathrel{=}\;\Con{branch\textrm{-}if\textrm{-}nil}\;(\F{index}\;\V{x})\;\V{l}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}0\textrm{-}new}\;\{\mskip1.5mu \V{v'}\;\mathrel{=}\;\V{v'}\mskip1.5mu\}\;\V{x})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}0}\;(\F{index}\;\V{x})\;\V{v'}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}0\textrm{-}upd}\;\V{x}\;\V{idx})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}0}\;(\F{index}\;\V{x})\;(\F{index}\;\V{idx}){}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}1\textrm{-}new}\;\{\mskip1.5mu \V{v'}\;\mathrel{=}\;\V{v'}\mskip1.5mu\}\;\V{x})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}1}\;(\F{index}\;\V{x})\;\V{v'}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}fetch\textrm{-}1\textrm{-}upd}\;\V{x}\;\V{idx})\;\mathrel{=}\;\Con{fetch\textrm{-}field\textrm{-}1}\;(\F{index}\;\V{x})\;(\F{index}\;\V{idx}){}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}cons\textrm{-}new}\;\{\mskip1.5mu \V{v'}\;\mathrel{=}\;\V{v'}\mskip1.5mu\}\;\V{x}\;\V{x₁}\;\V{x₂})\;\mathrel{=}\;\Con{cons}\;(\F{index}\;\V{x})\;(\F{index}\;\V{x₁})\;\V{v'}{}\<[E]%
\\
\>[B]{}\F{forge\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}cons\textrm{-}upd}\;\V{x}\;\V{x₁}\;\V{idx}\;\V{x₂})\;\mathrel{=}\;\Con{cons}\;(\F{index}\;\V{x})\;(\F{index}\;\V{x₁})\;(\F{index}\;\V{idx}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Finally, we can define a view of an untyped instruction (\ensuremath{\D{UInstr}\;\V{n}}) as being the
erasure of an intrinsically-typed one using the type \ensuremath{\D{CheckedInstr}}:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{data}\;\D{CheckedInstr}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;(\V{\Pi}\;\mathbin{:}\;\D{PCtx}\;\V{n})\;(\V{\Gamma}\;\mathbin{:}\;\D{Ctx})\;\mathbin{:}\;\D{UInstr}\;\V{n}\;\rightarrow\;\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{ok}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;(\V{i}\;\mathbin{:}\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;\V{\Gamma'})\;\rightarrow\;\D{CheckedInstr}\;\V{\Pi}\;\V{\Gamma}\;(\F{forge\textrm{-}types\textrm{-}instr}\;\V{i}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks


For brevity, we show how we type-check only one instruction\footnote{The curious reader can refer to our
online repository~\cite{list-rep} for a complete implementation.}. Function \ensuremath{\F{check\textrm{-}fetch\textrm{-}field\textrm{-}0}}
receives a program context, a typing context, and two named variables, and returns a \ensuremath{\D{TC}} value:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\D{TC}\;\mathbin{:}\;\D{Set}\;\rightarrow\;\D{Set}{}\<[E]%
\\
\>[B]{}\D{TC}\;\V{i}\;\mathrel{=}\;\D{Either}\;\D{TypeError}\;\V{i}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
which is either an error message or a \ensuremath{\D{CheckedInstr}} indicating that the term type-checks.
The \ensuremath{\D{TypeError}} contains one constructor for each of the possible failures causes for an
input program.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{data}\;\D{TypeError}\;\mathbin{:}\;\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{UnexpectedTy}\;\mathbin{:}\;\D{Ty}\;\rightarrow\;\D{TypeError}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{UndefinedVar}\;\mathbin{:}\;\D{\mathbb{N}}\;{}\<[21]%
\>[21]{}\rightarrow\;\D{TypeError}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{UndefinedLabel}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;\rightarrow\;\D{Label}\;\V{n}\;\rightarrow\;\D{TypeError}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
In the code below, we use the function \ensuremath{\F{lookup\textrm{-}var}} to provide the \emph{de Bruijn} indices for
each variable, and match the first with its possible forms. The first three cases indicate
type errors: (1) when \ensuremath{\V{v}} is \ensuremath{\Con{outside}} it means a variable scope error; (2) and (3) are typing errors,
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{check\textrm{-}fetch\textrm{-}field\textrm{-}0}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{n}\mskip1.5mu\}\;(\V{\Pi}\;\mathbin{:}\;\D{PCtx}\;\V{n})\;\V{\Gamma}\;\V{v}\;\V{v'}\;\rightarrow\;\D{TC}\;(\D{CheckedInstr}\;\V{\Pi}\;\V{\Gamma}\;(\Con{fetch\textrm{-}field\textrm{-}0}\;\V{v}\;\V{v'})){}\<[E]%
\\
\>[B]{}\F{check\textrm{-}fetch\textrm{-}field\textrm{-}0}\;\V{\Pi}\;\V{\Gamma}\;\V{v}\;\V{v'}\;\mathkw{with}\;\F{lookup\textrm{-}var}\;\V{\Gamma}\;\V{v}\;\mid \;\F{lookup\textrm{-}var}\;\V{\Gamma}\;\V{v'}{}\<[E]%
\\
\>[B]{}\V{...}\;\mid \;\Con{outside}\;\mid \;\anonymous \;\mathrel{=}\;\Con{undefined\textrm{-}var}\;\V{v}{}\<[E]%
\\
\>[B]{}\V{...}\;\mid \;\Con{inside}\;\Con{nil}\;\V{p}\;\mid \;\V{q}\;\mathrel{=}\;\Con{type\textrm{-}error}\;\Con{nil}{}\<[E]%
\\
\>[B]{}\V{...}\;\mid \;\Con{inside}\;(\Con{list}\;\V{x})\;\V{p}\;\mid \;\V{q}\;\mathrel{=}\;\Con{type\textrm{-}error}\;(\Con{list}\;\V{x}){}\<[E]%
\\
\>[B]{}\V{...}\;\mid \;\Con{inside}\;(\Con{listcons}\;\V{x})\;\V{p}\;\mid \;\Con{inside}\;\V{x₁}\;\V{p₁}\;\mathrel{=}\;\Con{right}\;(\Con{ok}\;(\Con{instr\textrm{-}fetch\textrm{-}0\textrm{-}upd}\;\V{p}\;\V{p₁})){}\<[E]%
\\
\>[B]{}\V{...}\;\mid \;\Con{inside}\;(\Con{listcons}\;\V{x})\;\V{p}\;\mid \;\Con{outside}\;\mathrel{=}\;\Con{right}\;(\Con{ok}\;(\Con{instr\textrm{-}fetch\textrm{-}0\textrm{-}new}\;\V{p})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Finally, functions \ensuremath{\Con{type\textrm{-}error}} and \ensuremath{\Con{undefined\textrm{-}var}} just build the corresponding
type-checker error as follows:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Con{type\textrm{-}error}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{i}\mskip1.5mu\}\;\rightarrow\;\D{Ty}\;\rightarrow\;\D{TC}\;\V{i}{}\<[E]%
\\
\>[B]{}\Con{type\textrm{-}error}\;\mathrel{=}\;\Con{left}\;\V{∘}\;\Con{UnexpectedTy}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Con{undefined\textrm{-}var}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{i}\mskip1.5mu\}\;\rightarrow\;\D{\mathbb{N}}\;\rightarrow\;\D{TC}\;\V{i}{}\<[E]%
\\
\>[B]{}\Con{undefined\textrm{-}var}\;\mathrel{=}\;\Con{left}\;\V{∘}\;\Con{UndefinedVar}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
The type \ensuremath{\Con{cont}} $\Gamma$ is given to program labels and it
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\orange{\texttt{-- unchanged from the previous code version.}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}getlabel\textrm{-}0}\;{}\<[25]%
\>[25]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\tau}\mskip1.5mu\}\;\rightarrow\;(\V{idx}\;\mathbin{:}\;\V{\tau}\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[25]{}\hsindent{8}{}\<[33]%
\>[33]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;\Con{nil}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{instr\textrm{-}getlabel}\;{}\<[25]%
\>[25]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{l}\;\V{\tau}\;\V{\Gamma_1}\mskip1.5mu\}\;\rightarrow\;(\V{idx}\;\mathbin{:}\;\V{\tau}\;\D{\in}\;\V{\Gamma})\;{}\<[E]%
\\
\>[25]{}\hsindent{13}{}\<[38]%
\>[38]{}\rightarrow\;\V{\Pi}\;\D{[}\;\V{l}\;\D{]=}\;\V{\Gamma_1}\;{}\<[E]%
\\
\>[25]{}\hsindent{13}{}\<[38]%
\>[38]{}\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;(\V{idx}\;\F{::=}\;\Con{cont}\;\V{\Gamma_1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Constructor \ensuremath{\Con{instr\textrm{-}getlabel\textrm{-}0}} encodes the typing rule for the instruction \textrm{get-label} when
the label involved is the special label $L_0$. Intutively, the constructor \ensuremath{\Con{instr\textrm{-}getlabel\textrm{-}0}} type
ensures that the type associated with the register for the instruction is the empty list type.
Next, constructor \ensuremath{\Con{instr\textrm{-}getlabel}} shows that any other label $l$ should be typed with a continuation
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{block\textrm{-}jump}\;{}\<[25]%
\>[25]{}\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{l}\;\V{\Gamma_1}\mskip1.5mu\}\;\rightarrow\;\Con{cont}\;\V{\Gamma_1}\;\D{\in}\;\V{\Gamma}\;{}\<[E]%
\\
\>[25]{}\rightarrow\;\V{\Gamma}\;\D{\subset}\;\V{\Gamma_1}\;{}\<[E]%
\\
\>[25]{}\rightarrow\;\D{Block}\;\V{\Pi}\;\V{\Gamma}\;\V{\Gamma_1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
we include a new constructor on type \ensuremath{\D{UInstr}} to represent untyped get-label instruction and
add its corresponding equation on function \ensuremath{\F{forget\textrm{-}types\textrm{-}instr}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{17}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{data}\;\D{UInstr}\;\mathbin{:}\;\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\orange{\texttt{-- same code from before.}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Con{get\textrm{-}label}\;{}\<[17]%
\>[17]{}\mathbin{:}\;(\V{v}\;\mathbin{:}\;\D{\mathbb{N}})\;\rightarrow\;\D{Label}\;\rightarrow\;\D{UInstr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Pi}\;\V{\Gamma}\;\V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;\V{\Pi}\;\D{\vdash}\;\V{\Gamma}\;\D{\Rightarrow}\;\V{\Gamma'}\;\rightarrow\;\D{UInstr}{}\<[E]%
\\
\>[B]{}\orange{\texttt{-- same code as before...}}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}getlabel\textrm{-}0}\;\{\mskip1.5mu \V{x}\;\mathrel{=}\;\V{x}\mskip1.5mu\}\;\V{v})\;\mathrel{=}\;\Con{get\textrm{-}label}\;\V{x}\;\Con{zero}{}\<[E]%
\\
\>[B]{}\F{forget\textrm{-}types\textrm{-}instr}\;(\Con{instr\textrm{-}getlabel}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\{\mskip1.5mu \V{x}\;\mathrel{=}\;\V{x}\mskip1.5mu\}\;\V{v}\;\V{p})\;\mathrel{=}\;\Con{get\textrm{-}label}\;\V{x}\;\V{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Constructor \ensuremath{\Con{get\textrm{-}label}} stores the name for a register and a label which is loaded into the register.
Equations for erasing type information are immediate. The only peculiarity is that when the instruction
\ensuremath{\Con{get\textrm{-}label}} is typed using rule \ensuremath{\Con{instr\textrm{-}getlabel\textrm{-}0}} we consider the initial label \ensuremath{\Con{zero}}.
Next, we implement the type checker logic for \ensuremath{\Con{get\textrm{-}label}}. Function \ensuremath{\F{check\textrm{-}get\textrm{-}label}} verifies if the label is present at
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{check\textrm{-}get\textrm{-}label}\;\mathbin{:}\;\D{\forall}\;\V{\Pi}\;\V{\Gamma}\;\V{v}\;\V{l}\;{}\<[30]%
\>[30]{}\rightarrow\;\D{TC}\;(\D{CheckedInstr}\;\V{\Pi}\;\V{\Gamma}\;(\Con{get\textrm{-}label}\;\V{v}\;\V{l})){}\<[E]%
\\
\>[B]{}\F{check\textrm{-}get\textrm{-}label}\;\V{\Pi}\;\V{\Gamma}\;\V{v}\;\V{l}\;\mathkw{with}\;\F{inspect}\;(\F{lookup}\;\V{\Pi}\;\V{l}){}\<[E]%
\\
\>[B]{}\F{check\textrm{-}get\textrm{-}label}\;\V{\Pi}\;\V{\Gamma}\;\V{v}\;\V{l}\;\mid \;{}\<[28]%
\>[28]{}\V{\Gamma_1}\;\F{with\equiv}\;\V{p}\;\mathkw{with}\;\F{lookup\textrm{-}var}\;\V{\Gamma}\;\V{v}{}\<[E]%
\\
\>[B]{}\F{check\textrm{-}get\textrm{-}label}\;\V{\Pi}\;\V{\Gamma}\;.\;(\F{index}\;\V{p₁})\;\V{l}\;\mid \;\V{\Gamma_1}\;\F{with\equiv}\;\V{p}\;\mid \;\Con{inside}\;\V{x}\;\V{p₁}\;{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathrel{=}\;\Con{right}\;(\Con{ok}\;(\Con{instr\textrm{-}getlabel}\;\V{p₁}\;(\F{lookup⇒[]=}\;\V{l}\;\V{\Pi}\;\V{p}))){}\<[E]%
\\
\>[B]{}\F{check\textrm{-}get\textrm{-}label}\;\V{\Pi}\;\V{\Gamma}\;\V{v}\;\V{l}\;\mid \;\V{\Gamma_1}\;\F{with\equiv}\;\V{p}\;\mid \;\Con{outside}\;\mathrel{=}\;\Con{undefined\textrm{-}var}\;\V{v}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathkw{data}\;\D{Val}\;\mathbin{:}\;\D{Ty}\;\rightarrow\;\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\orange{\texttt{-- same code as before}}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Con{cont}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Gamma_1}\mskip1.5mu\}\;\rightarrow\;\D{Env}\;\V{\Gamma_1}\;\rightarrow\;\D{Val}\;(\Con{cont}\;\V{\Gamma_1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\Con{get\textrm{-}label}} instruction and adjusting the \ensuremath{\Con{jump}} implementation.
Equations for \ensuremath{\Con{get\textrm{-}label}} simply update the current environment using the label. When the
typed syntax is built using constructor \ensuremath{\Con{instr\textrm{-}getlabel\textrm{-}0}}, the environment is updated with
value \ensuremath{\Con{nil}}, which denotes the initial continuation for the program execution.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{run\textrm{-}step}\;(\Con{suc}\;\V{n})\;\V{penv}\;\V{p}\;\V{env}\;(\Con{block\textrm{-}seq}\;(\Con{instr\textrm{-}getlabel\textrm{-}0}\;\V{idx})\;\V{b})\;{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathrel{=}\;\F{run\textrm{-}step}\;\V{n}\;\V{penv}\;\V{p}\;(\F{update\textrm{-}env}\;\V{env}\;\V{idx}\;\Con{nil})\;\V{b}{}\<[E]%
\\
\>[B]{}\F{run\textrm{-}step}\;(\Con{suc}\;\V{n})\;\V{penv}\;\V{p}\;\V{env}\;(\Con{block\textrm{-}seq}\;(\Con{instr\textrm{-}getlabel}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{idx}\;\V{x})\;\V{b})\;{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathrel{=}\;\F{run\textrm{-}step}\;\V{n}\;\V{penv}\;\V{p}\;(\F{update\textrm{-}env}\;\V{env}\;\V{idx}\;(\Con{cont}\;\V{x}))\;\V{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
variable using \ensuremath{\F{lookup}\;\V{env}\;\V{v}}. Using the label associated with the retrieved continuation value
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\F{run\textrm{-}step}\;(\Con{suc}\;\V{n})\;\V{penv}\;\V{p}\;\V{env}\;(\Con{block\textrm{-}jump}\;\V{v}\;\V{x₁})\;\mathkw{with}\;\F{lookup}\;\V{env}\;\V{v}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\V{...|}\;(\Con{cont}\;\{\mskip1.5mu \V{l}\;\mathrel{=}\;\V{l}\mskip1.5mu\}\;\V{k})\;\mathkw{rewrite}\;\D{sym}\;(\F{[]\textrm{=}{\Rightarrow}lookup}\;\V{k})\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathrel{=}\;\F{run\textrm{-}step}\;\V{n}\;\V{penv}\;\V{p}\;(\F{lookupA}\;\V{l}\;\V{penv})\;(\F{lookupA}\;\V{l}\;\V{p}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathkw{postulate}\;\V{sub-env}\;\mathbin{:}\;\D{\forall}\;\{\mskip1.5mu \V{\Gamma}\;\V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;\V{\Gamma'}\;\D{\subset}\;\V{\Gamma}\;\rightarrow\;\D{Env}\;\V{\Gamma}\;\rightarrow\;\D{Env}\;\V{\Gamma'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
