...
We use the \ensuremath{\V{All}} datatype to express this relation.
...
\\
\>[B]{}\D{Program}\;\V{\Pi}\;\mathrel{=}\;\D{\forall}\;\{\mskip1.5mu \V{\Gamma'}\mskip1.5mu\}\;\rightarrow\;\V{All}\;(\lambda\;\V{\Gamma}\;\rightarrow\;\D{Block}\;\V{\Pi}\;\V{\Gamma}\;\V{\Gamma'})\;\V{\Pi}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
We use the datatype \ensuremath{\V{All}} (and \ensuremath{\D{Allv}} for vectors) to define the notion of well-typed
...
\\
\>[B]{}\D{Env}\;\V{\Gamma}\;\mathrel{=}\;\V{All}\;(\lambda\;(\V{x}\;\red{,}\,\;\V{\tau})\;\rightarrow\;\D{Val}\;\V{\tau})\;\V{\Gamma}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
stores it in a new variable. The \ensuremath{\V{lookup}} function projects the value of variable \ensuremath{\V{v}} from the run-time
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathkw{with}\;\V{lookup}\;\V{env}\;\V{v}{}\<[E]%
\\
...
result type of this list is the least common subtype between these two. As before, we use the \ensuremath{\V{lookup}}
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}(\F{lub\textrm{-}of\textrm{-}subtype}\;(\F{lub\textrm{-}subtype\textrm{-}left}\;\V{s}))))\;(\V{lookup}\;\V{env}\;\V{v₀}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Con{::}\;\F{\textrm{<:-}val}\;(\F{lub\textrm{-}subtype\textrm{-}right}\;\V{s})\;(\V{lookup}\;\V{env}\;\V{v₁}))\;\Con{::}\;\V{env})\;\V{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
